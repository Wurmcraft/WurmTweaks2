...
public class Mekanism extends SupportHelper {
	...
	public void addEnrichmentChamber (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 2,"addEnrichmentChamber('<output> <input>')");
	...
	public void addOsmiumCompressor (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 2,"addOsmiumCompressor('<output> <input>')");
		isValid (helper,input[0],input[1]);
	...
	public void addCombiner (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 2,"addCombiner('<output> <input>')");
		isValid (helper,input[0],input[1]);
	...
	public void addMCrusher (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 2,"addMCrusher('<output> <input>')");
		isValid (helper,input[0],input[1]);
	...
	public void addPurification (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 2,"addPurification('<output> <input>')");
		isValid (helper,input[0],input[1]);
	...
	public void addMetallurgicInfuser (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 4,"addMetallurgicInfuser('<output> <input> <infusionType> <amount>')");
		isValid (helper,input[0],input[1]);
	...
	public void addChemicalInfuser (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 3,"addChemicalInfuser('<%output> <%input> <%input2>')");
	...
	public void addChemicalOxidizer (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 2,"addChemicalOxidizer('<%output> <input>')");
		GasStack output = getGasStack (input[0]);
		Preconditions.checkNotNull (output);
	...
	public void addChemicalInjection (StackHelper helper,String line) {
		String[] input = validate (line,line.split ("").length == 3,"addChemicalInjection('<output> <input> <%input>')");
		isValid (helper,input[0],input[1]);
	...
	public void addElectrolyticSeparator (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 4,"addElectrolyticSeparator('<leftOutput> <rightOutput> <*input> <energy>')");
	...
	public void addSawmill (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 2 || line.split (" ").length == 4,"addSawmill('<output> <input> | <secOutput> <secOutput%>')");
		isValid (helper,input[0],input[1]);
	...
	public void addChemicalDissolution (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 2,"addChemicalDissolution('<%output> <input>')");
		GasStack output = getGasStack (input[0]);
		Preconditions.checkNotNull (output);
		isValid (helper,input[1]);
	...
	public void addChemicalWasher (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 2,"addChemicalWasher('<%output> <%input>')");
		GasStack output = getGasStack (input[0]);
		Preconditions.checkNotNull (output);
		GasStack inputStack = getGasStack (input[1]);
		Preconditions.checkNotNull (inputStack);
	...
	public void addChemicalCrystallizer (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 2,"addChemicalCrystallizer('<output> <%input>')");
	...
	public void addPressureChamber (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 7,"addPressureChamber('<output> <%outputGas> <%inputGas> <*inputFluid> <input> <extraEnergy> <time>')");
	...
	public void addThermalEvaporation (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 2,"addThermalEvaporation('<*output> <*input>')");
	...
	public void addSolarNeutron (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 2,"addSolarNeutron('<%output> <%input>')");
		GasStack output = getGasStack (input[0]);
		Preconditions.checkNotNull (output);
		GasStack inputStack = getGasStack (input[1]);
		Preconditions.checkNotNull (inputStack);
	...
	private GasStack getGasStack (String stack) {
		if (stack.startsWith (StackSettings.FRONT + StackSettings.GAS.toString ())) {
			String name = stack.substring (stack.indexOf (StackSettings.FRONT.toString ().charAt (0)) + 1,stack.indexOf (StackSettings.BACK.toString ().charAt (0)));
			int amount = Integer.parseInt (stack.substring (stack.indexOf (StackSettings.FRONT.toString () + StackSettings.GAS.toString ()) + 2,stack.indexOf (StackSettings.STACK_SIZE.toString ())));
