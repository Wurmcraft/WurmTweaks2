...
public class Avaritia extends SupportBase {
 ...
 public void addShapedExtreme(StackHelper helper, String line) {
  String[] input = validateFormat(line, line.split(" ").length >= 3, "addShapedExtreme('<output> <style> <format')");
 ...
 public void addShapelessExtreme(StackHelper helper, String line) {
  String[] input = validateFormat(line, line.split(" ").length >= 2, "addShapelessExtreme('<output> <input>...')");
  isValid(helper, input[0]);
 ...
 public void addCompression(StackHelper helper, String line) {
  String[] input = validateFormat(line, line.split(" ").length == 2, "addCompression('<output> <input>')");
