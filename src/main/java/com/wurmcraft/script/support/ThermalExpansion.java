...
public class ThermalExpansion extends SupportHelper {

	private List <Object[]> furnace = Collections.synchronizedList (new ArrayList<> ());
	private List<Object[]> pulverizer = Collections.synchronizedList (new ArrayList <> ());
	private List <Object[]> sawmill = Collections.synchronizedList (new ArrayList <> ());
	private List <Object[]> smelter = Collections.synchronizedList (new ArrayList <> ());
	private List <Object[]> compactor = Collections.synchronizedList (new ArrayList <> ());
	private List <Object[]> crucible = Collections.synchronizedList (new ArrayList <> ());
	private List <Object[]> centerfuge = Collections.synchronizedList (new ArrayList <> ());
	...
	public void addRedstoneFurnace (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length >= 2,"addRedstoneFurnace('<output> <input> <energy>')");
	...
	public void addPulverizer (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length >= 3,"addPulverizer('<output> <input> <energy> | <secOutput> <secOutput%>')");
		isValid (helper,input[0],input[1]);
		isValid (Types.INTEGER, helper,input[2]);
		if (input.length == 3)
	...
	public void addTESawmill (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 3,"addTESawmill('<output> <input> <energy>')");
		isValid (helper,input[0],input[1]);
		isValid (Types.INTEGER, helper,input[2]);
	...
	public void addSmelter (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 4,"addSmelter('<output> <inputA> <inputB> <energy')");
	...
	public void addCompactor (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 4,"addCompactor('<output> <input> <energy> <mode>')");
		isValid (helper,input[0],input[1]);
		isValid (Types.INTEGER, helper,input[2]);
	...
	public void addMagmaCrucible (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 3,"addMagmaCrucible('<*output> <input> <energy>')");
	...
	public void addTECenterfuge (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 7,"addCenterfuge('<output> <output2> <output3> <output4> <input> <energy> <*output5>')");
