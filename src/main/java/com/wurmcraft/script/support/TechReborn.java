...
public class TechReborn extends SupportHelper {
	...
	public void addShapelessRolling (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length >= 2 && line.split (" ").length <= 10,"addShapelessRolling('<output> <input>...')");
	...
	public void addShapedRolling (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length > 4,"addShapedRolling(<output> <style> <format>')");
		isValid (helper,input[0]);
		ItemStack output = convertStack (helper,input[0]);
	...
	public void addScrapbox (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 1,"addScrapbox('<stack>')");
		isValid (helper,input[0]);
	...
	public void addGeneratorFluid (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 3,"addGeneratorFluid('<type> <*fluid> <energy>')");
	...
	public void addTechFusion (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 6,"addTechFusion('<output> <topInput> <bottomInput> <startEU> <euTick> <time>')");
	...
	public void addAlloySmelter (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 5,"addAlloySmelter('<output> <input> <input2> <time> <euTick>')");
		isValid (helper,input[0],input[1],input[2]);
	...
	public void addAssemblingMachine (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 5,"addAssemblingMachine('<output> <input> <input2> <time> <euTick>')");
		isValid (helper,input[0],input[1],input[2]);
		isValid (Types.INTEGER,helper,input[3],input[4]);
	...
	public void addIndustrialBlastFurnace (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 7,"addIndustrialBlastFurnace('<output> <output2> <input> <input2> <time> <euTick> <heat>')");
	...
	public void addTRCenterfuge (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 8,"addCenterfuge('<output> <output2> <output3> <input> <input2> <time> <euTick> <output4>')");
	...
	public void addChemicalReactor (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 5,"addChemicalReactor('<output> <input> <time> <euTick>')");
		isValid (helper,input[0],input[1],input[2]);
		isValid (Types.INTEGER,helper,input[3],input[4]);
	...
	public void addCompressor (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 4,"addGrinder('<output> <input> <time> <euTick>')");
	...
	public void addDistillationTower (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 7,"addDistillationTower('<output> <output2> <output3> <input> <input2> <time> <euTick>'");
	...
	public void addExtractor (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 4,"addExtractor('<output> <input> <time> <euTick>')");
		isValid (helper,input[0],input[1]);
		isValid (Types.INTEGER,helper,input[2],input[3]);
	...
	public void addImplosionCompressor (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 6,"addImplosionCompressor('<output> <output2> <input> <input2> <time> <euTick>')");
		isValid (helper,input[0],input[1],input[2],input[3]);
	...
	public void addIndustrialElectrolyzer (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 7,"addIndustrialElectrolyzer('<output> <output2> <output3> <input> <input2> <time> <euTick>')");
		isValid (helper,input[0],input[1],input[2],input[3],input[4],input[5]);
		isValid (Types.INTEGER,helper,input[6],input[7]);
	...
	public void addIndustrialGrinder (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 7,"addIndustrialGrinder('<output> <output2> <output3> <input> <input2> <time> <euTick>')");
	...
	public void addIndustrialSawmill (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 7,"addIndustrialSawmill('<output> <output2> <output3> <input> <input2> <time> <euTick>')");
		isValid (helper,input[0],input[1],input[2],input[3]);
		isValid (Types.INTEGER,helper,input[5],input[6]);
	...
	public void addVacuumFreezer (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 4,"addVacuumFreezer('<output> <input> <time> <euTick')");
		isValid (helper,input[0],input[1]);
		isValid (Types.INTEGER,helper,input[2],input[3]);
