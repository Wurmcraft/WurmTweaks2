...
public class GalacticCraft extends SupportHelper {
	...
	public void addShapedCompressor (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length > 4,"addShapedCompressor(<output> <style> <format>')");
	...
	public void addShapelessCompressor (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length >= 2 && line.split (" ").length <= 10,"addShapelessCompressor('<output> <input>...')");
		isValid (helper,input[0]);
	...
	public void addCircuitFabricator (StackHelper helper,String line) {
		String[] input = validate (line,line.length () == 5,"addCircuitFabricator('<output> <input> <input2> <input3> <input4>')");
	...
	public void addSpaceStationRecipe (StackHelper helper,String line) {
		String[] input = validate (line,line.length () >= 2,"addSpaceStationRecipe('<stationID> <items>...')");
