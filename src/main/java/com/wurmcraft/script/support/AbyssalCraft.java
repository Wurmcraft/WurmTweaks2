...
public class AbyssalCraft extends SupportHelper {
	...
	public void addCrystallizer (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 4,"addCrystallizer('<output> <output2> <input> <exp>')");
	...
	public void addTransmutator (StackHelper helper,String line) {
		String input[] = validate (line,line.split (" ").length == 3,"addTransmutator('<output> <input> <energy>')");
	...
	public void addMaterializer (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length >= 2,"addMaterializer('<output> <input>...')");
