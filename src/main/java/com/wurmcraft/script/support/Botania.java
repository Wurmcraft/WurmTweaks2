...
public class Botania extends SupportHelper {
	...
	public void addApothecary (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length >= 2,"addApothecary('<output> <input>...')");
	...
	public void addPureDaisy (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 2,"addPureDaisy('<output> <input>')");
	...
	public void addRune (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length >= 3,"addRune('<output> <mana> <input>...')");
	...
	public void addElven (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 2,"addElven('<output> <input>')");
		isValid (helper,input[0],input[1]);
	...
	public void addInfusion (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 3,"addInfusion('<output> <input> <mana>')");
		isValid (helper,input[0],input[1]);
	...
	public void addAlchemy (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 3,"addAlchemy('<output> <input> <mana>')");
		isValid (helper,input[0],input[1]);
		isValid (Types.INTEGER,helper,input[2]);
	...
	public void addConjuration (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 3,"addConjuration('<output> <input> <mana>')");
		isValid (helper,input[0],input[1]);
		isValid (Types.INTEGER,helper,input[2]);
