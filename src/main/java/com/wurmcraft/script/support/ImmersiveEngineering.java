...
public class ImmersiveEngineering extends SupportHelper {
	...
	public void addAlloyRecipe (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 4,"addAlloyRecipe('<output> <input> <input2> <time>");
	...
	public void addArcFurnace (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length >= 4,"addArcFurnace('<output> <slag> <input> <time> <energy> | <additives'");
		isValid (helper,input[0],input[1],input[2]);
	...
	public void addBlastFurnace (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 4,"addBlastFurnace(<output> <slag> <input> <time>')");
		isValid (helper,input[0],input[1],input[2]);
		isValid (Types.INTEGER,helper,input[3]);
	...
	public void addBlastFuel (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 2,"addBlastFuel('<stack> <time>')");
	...
	public void addCokeOven (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 4,"addCokeOven('<output> <input> <creosote> <time>')");
	...
	public void addCrusher (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 3 || line.split (" ").length == 5,"addCrusher('<output> <input> <energy> | <secOutput> <secOutput%>)");
		isValid (helper,input[0],input[1]);
	...
	public void addFermenter (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 4,"addFermenter('<output> <*output> <input> <energy')");
	...
	public void addMetalPress (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 4,"addMetalPress(<output> <input> <mold> <time>')");
		isValid (helper,input[0],input[1],input[2]);
		isValid (Types.INTEGER,helper,input[3]);
	...
	public void addRefinery (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 4,"addRefinery('<*output> <*input> <*input> <energy>')");
	...
	public void addSqueezer (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 4,"addSqueezer('<output> <*output> <input> <energy>')");
		isValid (helper,input[0],input[2]);
		isValid (Types.FLUIDSTACK,helper,input[1]);
		isValid (Types.INTEGER,helper,input[2]);
		squeezer.add (new Object[] {convertFluidStack (helper,input[1]),convertStack (helper,input[0]),convertStack (helper,input[1]),convertInteger (input[2])});
	}
}
