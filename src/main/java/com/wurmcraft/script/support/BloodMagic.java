...
public class BloodMagic extends SupportHelper {
	...
	public void addAltar (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 6,"addAltar('<output> <input> <tier> <syphon> <consume> <drain>')");
	...
	public void addAlchemyArray (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length == 3,"addAlchemyArray('<output> <catalyst> <input')");
	...
	public void addSoulForge (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length >= 4,"addSoulForge('<output> <souls> <drain> <input>...')");
	...
	public void addTable (StackHelper helper,String line) {
		String[] input = validate (line,line.split (" ").length >= 5,"addTable('<output> <syphon> <ticks> <tier> <input>...')");
		isValid (helper,input[0]);
