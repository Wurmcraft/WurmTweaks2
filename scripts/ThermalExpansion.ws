...
// Centerfuge
// addTECenterfuge('<output> <output2> <output3> <output4> <input> <energy> <*output5>')
addTECenterfuge('<1xminecraft:apple> <1xminecraft:apple> <1xminecraft:apple> <1xminecraft:apple> <1xminecraft:golden_apple> 600 <*100xlava>')